...
kmeans_model = joblib.load("PerfectPiano_clustering.pkl")
tfidf_vectorizer = joblib.load("PerfectPiano_tfidf_vectorizer.pkl")
    ...
    if file:
        ...
        if not required_cols.issubset(df.columns):
            ...
            st.download_button(
                ...
                file_name="hasil_klaster_perfect_piano.csv",
                mime="text/csv"
            )
